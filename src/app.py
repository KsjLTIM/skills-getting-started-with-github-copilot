...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice, stroke improvement, and pool games",
    ...
    "Drama Club": {
        "description": "Acting workshops, script readings, and stage productions",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["ethan@mergington.edu", "amanda@mergington.edu"]
    }
}
